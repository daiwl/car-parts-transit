package ru.d4nik.carparts.components.autocompass.adapters.arlanavto;
...
public class ArlanAvtoAdapter {
    ...
    private static final String SEND_FROM = "danil.ivanov.v@ya.ru";
    public static final String[] HEADER_LINE = {"Наименование", "Номер артикула", "Бренд", "Кол-во", "Цена", "Срок в днях", "Кратность"};
...
//    }
    ...
    public void sendMailWithAttachment(String to, String subject, InputStreamSource fileToAttach) {
        ...
        try {
            ...
            helper.setTo(to);
            helper.setFrom(SEND_FROM, "evgeniy.kiselev@ya.ru");
